...
The anova test result does show that fixed acidity is statistically significant between the two subgroups high and low quality.  
...
As mentioned earlier, too high or too low of volatile acidity can give bad smell and leave the consumer with an unpleasant experience. Perhaps this confirms our initial idea.   
...
Overall high quality is associated with less density. Remember lesser the residual sugar, higher the alcohol. Then lesser the density ?  
...
## Statistical significance between two high and low quality in Sulphate  
...
In White wine, the sulphate level does not appear to show statistical significance between two subgroups and hence I conclude any difference between them are just due to mere chance (Fail to reject $H_{0}$).  
